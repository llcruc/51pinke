...
<body>
	...
	<div class="container">
		<ul class="breadcrumb">
			...
			<li><a href="page!userfile.action">我的文档</a><span
				class="divider">/</span></li> 
		</ul>
		<div class="container">
			...
			<div class="row-fluid">
				...
				<div class="span2" id="userinfo">
					...
					<div>
						<ul class="nav nav-pills nav-stacked" id="userinfo3">
							...
							<li class="active"><a href="page!userfile.action">我的文档</a></li>
				...
				<div class="span10" style="width: 80%;">
					...
					<iframe name="filelist" frameborder="0" scrolling="no" width="100%" onload="Javascript:iframeAutoFit(this)"
  	                      src="main!userfilelist2.action?userid=<s:property value="#session.user.userid"/>&filepageNow=1" id="userfilelist" height="600px;"></iframe>
	...
	<form name="deleteform" action="file!filedelete.action" method="post">
