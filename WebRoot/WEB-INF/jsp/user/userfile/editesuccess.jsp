		...
		<div class="container">
			...
			<div class="upload_widget">
				<div class="upload_header" style="height: 55px;">
                 ...
                 <div class="container">
                    <div style="margin-left: 30%; margin-top: 110px;">
				      <ul ><li class='upload_signsuc2' style="padding-left: 12%"><h3>文档编辑成功</h3></li>
				        <li class="backupload"><a href="<%=basePath%>file!preview.action?fileid=<s:property value="fileid"/>" style="color: rgb(25, 169, 123);">>>查看该文档</a></li>
				      </ul>
