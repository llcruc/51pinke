			...
			<div class="row-fluid">
				...
				<div class="span12">
					<div id="course_header">
						<h4
							style="padding-top: 10px; margin-bottom: 0px;color: rgb(2, 61, 92);margin-left: 7px;">教师信息</h4>
					</div>
						...
						<div class="row-fluid">
							<div class="span8">
								<form class="form-horizontal">
									<div class="control-group">
										...
										<div class="controls">
											<div id="info1">
												<s:property value="rucTeacher.teachername" />
											</div>
										</div>
									</div>
									<div class="control-group">
							...
							<div class="span4" style="text-align: center;">
								<s:if test="rucTeacher.teacherimg==null">
									<img alt="<s:property value="rucTeacher.teachername"/>"
										style="width: 65%;" class="course_img2"
										src="<%=basePath%>data/teacher/default_teacher.jpg" />
								</s:if>
								<s:else>
							...
							<div class="span12" style="margin-top: 15px;">
								<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
									...
									<div class="btn-group">
										<a class="btn" data-edit="bold" title="Bold (Ctrl/Cmd+B)"><i class="icon-bold"></i></a> <a class="btn" data-edit="italic" title="Italic (Ctrl/Cmd+I)"><i class="icon-italic"></i></a>
									</div>
									<div class="btn-group">
								...
								<div id="editor">${rucTeacher.teacherinfo }</div>

								<br> <input type="file" id="picFile"
									onchange="readFile(this)" style="display: none;" />
								<form action="course!check.action" name="checkform"
									method="post">
